...
class Mapel extends CI_Controller
{
    ...
    public function kd()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('message', 'Data Materi Berhasil Ditambahkan!');
    ...
    public function input()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('message', 'Data Pembelajaran Berhasil Ditambahkan!');
            redirect('admin/mapel');
        }
    }
    ...
    public function delete_kd()
    {
        ...
        $this->session->set_flashdata('message', 'Data Materi Berhasil Dihapus!');
    ...
    {
        $this->form_validation->set_rules('kd[]', 'Materi', 'required');
    }
}
