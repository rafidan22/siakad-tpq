...
class Nilai extends CI_Controller
{
    ...
    public function get_mapel()
    {
        ...
        $data       = $this->Mapel_model->get_mapel_with_jilid($id_jilid);
        if ($data->num_rows() > 0) {
    ...
    public function data_nilai_permapel()
    {
        ...
        if ($id_mapel == null || $id_jilid == null || $nilai == null) {
            ...
            $html = $html . '<div class="card">
                    ...
                    <div class="card-body">
                        <a href="' . base_url('admin/nilai/kd?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&nilai=' . $nilai) . '" class="btn btn-primary mb-3"><i class="fas fa-info-circle"></i> Cek Selengkapnya</i></a>
            ...
            $html = $html . '
                <div class="card">
                    <div class="card-header bg-behance">
                        <h6 class="text-white"> ' . $mapel['nama_mapel'] . ' / jilid ' . $jilid['jilid'] . ' (' . $nilai . ')</h6>
                    </div>
                    <div class="card-body">
                        <a href="' . base_url('admin/nilai/kd?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&nilai=' . $nilai) . '" class="btn btn-primary mb-3"><i class="fas fa-info-circle"></i> Cek Selengkapnya</i></a>
    ...
    public function data_nilai_perkd()
    {
        ...
        if ($data != null || $jenis != null) {
            ...
            $html = $html . '<div class="card">
                    <div class="card-body">
                        ' . anchor('admin/nilai/input?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&id_materi=' . $id_materi . '&nilai=' . $nilai, '<button class="btn btn-sm btn-primary mb-3 mr-2"><i class="fas fa-plus fa-sm"></i> Tambah Nilai</button>') . '
                        ' . anchor('admin/nilai/archivedata?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&id_materi=' . $id_materi . '&tahun=' . $tahun . '&nilai=' . $nilai, '<button class="btn btn-sm btn-dark mb-3 mr-2"><i class="fas fa-archive fa-sm"></i> Arsip Nilai</button>') . '
            ...
            foreach ($jenis as $jn => $value) {
                $html = $html . '<th class="text-center">' .
                    anchor('admin/nilai/edit?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&id_materi=' . $id_materi . '&jenis=' . $value->jenis . '&nilai=' . $nilai, '<div class="btn btn-sm btn-primary mr-1 ml-1 mb-1"><i class="fa fa-edit fa-sm"></i></div>') .
                    '<a href="' . base_url('admin/nilai/archive?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&id_materi=' . $id_materi . '&jenis=' . $value->jenis . '&nilai=' . $nilai) . '" class="btn btn-sm btn-dark mr-1 ml-1 mb-1" onclick="return deleteNilai(event)"><i class="fa fa-archive fa-sm"></i></a>' .
                    '</th>';
            }
    ...
    public function input()
    {
        ...
        $data = array(
            ...
            'breadcrumb'        => [
                ...
                2 => (object)[
                    'name' => 'Detail',
                    'link' => 'admin/nilai/kd?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&nilai=' . $nilai
                ],
                3 => (object)[
                    'name' => 'Input Nilai',
                    'link' => NULL
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('admin/nilai/kd?id_jilid=' . $id_jilid . '&id_mapel=' . $id_mapel . '&nilai=' . $nilai);
        }
    }
    ...
    public function archivedata()
    {
        ...
        $object_jenis   = ['Adab', 'Hafalan', 'Kelancaran'];
