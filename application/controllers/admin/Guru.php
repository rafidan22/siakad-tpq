...
class Guru extends CI_Controller
{
    ...
    function get_result_guru()
    {
        ...
        foreach ($list as $item) {
            ...
            $row[] = $item->alamat;
            $row[] = anchor('admin/guru/edit/' . $item->id_ustadz, '<div class="btn btn-sm btn-primary btn-xs mr-1 ml-1 mb-1"><i class="fa fa-edit"></i></div>')
                . '<a href="javascript:;" onclick="confirmDelete(' . $item->id_ustadz . ')" class="btn btn-sm btn-danger btn-delete-guru btn-xs mr-1 ml-1 mb-1"><i class="fa fa-trash"></i></a>';
            $data[] = $row;
        }
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (@$_FILES['photo']['name'] != null) {
                ...
                if ($this->upload->do_upload('photo')) {
                    ...
                    $this->session->set_flashdata('message', 'Data Ustadz/Ustadzah Berhasil Ditambahkan!');
                    redirect('admin/guru');
                } else {
    ...
    public function edit()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (@$_FILES['photo']['name'] != null) {
                ...
                $photo = NULL;
                $this->Guru_model->edit_data($id, $photo, $data['guru']['nama']);
                $this->session->set_flashdata('message', 'Data Ustadz/Ustadzah Berhasil Diupdate!');
                redirect('admin/guru');
            }
        }
    }
    ...
    public function delete()
    {
        ...
        $this->jilid_model->delete_walikelas($item['nama']);
        $this->Guru_model->delete_data($id);
        $this->session->set_flashdata('message', 'Data Ustadz/Ustadzah Berhasil Dihapus!');
        redirect('admin/guru');
    }
