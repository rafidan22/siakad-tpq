...
class LaporanNilai extends CI_Controller
{
            ...
            if ($result) {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="' . base_url('walikelas/laporannilai/excel_laporan?id_tahun=' . $id_tahun . '&id_jilid=' . $id_jilid . '&nilai=' . $nilai) . '" class="btn btn-success mb-2"><i class="fas fa-file-excel"></i> Print Excel</a>
    ...
    public function excel_laporan()
    {
        ...
        $result_jumlah  = $this->Laporan_model->get_data_nilai($id_tahun, $id_jilid, 'jumlah', $nilai);
        $result_rerata  = $this->Laporan_model->get_data_nilai($id_tahun, $id_jilid, 'rerata', $nilai);
        $this->myexcel->generate('ustadz', $nilai, $tahun, $jilid, $daftar_mapel, $result, $result_min, $result_max, $result_jumlah, $result_rerata);
    }
}
