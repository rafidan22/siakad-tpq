...
class DataDiri extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $santri      = $this->santri_model->get_detail_data($data['id_santri']);
        $data = array(
            'santri'      => $santri,
        ...
        $this->load->view('santri/profile', $data);
    ...
    public function password()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('templates/header');
            $this->load->view('templates_santri/sidebar', $data);
            $this->load->view('santri/profile_password', $data);
            $this->load->view('templates/footer');
        } else {
