        ...
        <div class="forms-container">
            <div class="signin">
                <form method="post" action="" class="sign-in-form">
                    <img src="<?php echo base_url() ?>assets/img/TPQ.png" alt="" class="image-logo">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" placeholder="Username / Email / ID santri" id="username" name="username" />
                    </div>
