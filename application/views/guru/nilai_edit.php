...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-sort-numeric-down"></i> Edit Nilai <?= $mapel['nama_mapel'] . ' / jilid ' . $jilid['jilid'] ?> <?= $thn = ($tahun) ? '(Tahun Ajaran ' . $tahun['nama'] . ' - toshi ' . $tahun['toshi'] . ')' : '(Tidak Ada Tahun Ajaran Yang Aktif)';  ?> - <?= $jenis_penilaian ?></h1>
    </div>
    <div class="card">
        <dic class="card-body">
