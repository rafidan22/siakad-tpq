<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-sort-numeric-down"></i> Input Nilai <?= $mapel['nama_mapel'] . ' / jilid ' . $jilid['jilid'] ?> <?= $thn = ($tahun) ? '(Tahun Ajaran ' . $tahun['nama'] . ' - toshi ' . $tahun['toshi'] . ')' : '(Tidak Ada Tahun Ajaran Yang Aktif)';  ?> - <?= $jenis_penilaian ?></h1>
    </div>
        ...
        <dic class="card-body">
            <form action="" method="post">
                ...
                <div class="mb-3 row form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama" id="nama" value="<?= $komp_dasar['nama_materi'] ?>" class="form-control-plaintext" readonly="readonly">
                    </div>
                </div>
                <div class="mb-3 row form-group">
