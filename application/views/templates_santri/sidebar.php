...
<body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        ...
        <ul class="c-sidebar-nav">
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'dashboard') echo 'c-active' ?>" href="<?= base_url('santri') ?>">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="<?= base_url() ?>assets/vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
                    </svg><b> Dashboard</b></a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'data diri') echo 'c-active' ?>" href="<?= base_url('santri/datadiri') ?>">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="<?= base_url() ?>assets/vendors/@coreui/icons/svg/free.svg#cil-user"></use>
                    </svg><b> Data Diri</b></a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'nilai') echo 'c-active' ?>" href="<?= base_url('santri/nilai') ?>">
                    <svg class="c-sidebar-nav-icon">
                        <use xlink:href="<?= base_url() ?>assets/vendors/@coreui/icons/svg/free.svg#cil-education"></use>
                    </svg><b> Informasi Nilai</b></a></li>
            <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link <?php if ($menu == 'password') echo 'c-active' ?>" href="<?= base_url('santri/datadiri/password') ?>">
                    <svg class="c-sidebar-nav-icon">
