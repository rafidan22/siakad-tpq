...
<body style="background-color: white; color: black;">
    ...
    <hr class="line-title">
    <p align="center">
        <span style="font-size: 20px">LAPORAN DATA NILAI santri</span>
        <br>
    ...
    <table class="table table-bordered" id="table-laporansantri" style="width: 100%;">
        <thead>
            <tr class="text-center">
                ...
                <th style="vertical-align : middle;text-align:center;">tgl_masuk</th>
                <th style="vertical-align : middle;text-align:center;">Nama</th>
                <?php foreach ($daftar_kd as $key => $value) : ?>
                    <th style="vertical-align : middle;text-align:center;"><?= $value->nama_materi ?></th>
                <?php endforeach; ?>
                <th>Jumlah</th>
                <th>Rata-rata</th>
            </tr>
        ...
        <tbody>
            <?php foreach ($data_default as $dt => $value_dt) : ?>
                <tr>
                    ...
                    <td width="20px"><?= $value_dt['tgl_masuk'] ?></td>
                    <td><?= $value_dt['nama'] ?></td>
                    <?php foreach ($daftar_kd as $kd => $value_kd) : ?>
                        <td><?= $value_dt[$value_kd->nama_materi] ?></td>
                    <?php endforeach; ?>
