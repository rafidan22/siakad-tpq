    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="" method="post">
                ...
                <div class="form-group">
                    <label for="">toshi</label>
                    <select class="form-control" id="toshi" name="toshi">
                        <?php foreach ($toshi as $st) : ?>
                            <?php if ($st == $tahun['toshi']) : ?>
                    ...
                    <?php echo form_error('toshi', '<div class="text-danger small ml-3">', '</div>') ?>
                </div>
                <div class="form-group">
