<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-archive"></i> Arsip Nilai <?= $jenis_nilai ?></h1>
    </div>
    <div class="card">
        <div class="card-body">
            <?php if (isset($data)) : ?>
            ...
            $(document).ready(function() {
                $('#newjenis').change(function() {
                    ...
                    $(document).on('click', '#setcancelarchive', function() {
                        const href = '<?= base_url('admin/nilai/archive_cancel') ?>' + `?id_jilid=${idjilid}&id_mapel=${idMapel}&id_materi=${idKd}&nilai=${jetgl_masukilai}&oldjenis=${oldJenisTugas}&newjenis=${newJenisTugas}`;
