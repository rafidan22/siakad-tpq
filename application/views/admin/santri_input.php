                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nis" id="nis" placeholder="Masukan Id santri" class="form-control">
                                <?php echo form_error('nis', '<div class="text-danger small ml-3">', '</div>') ?>
                            </div>
                            <div class="form-group">
                                <label for="tgl_masuk">Tanggal Masuk TPQ</label>
                                <input type="text" name="tgl_masuk" id="tgl_masuk" placeholder="Format DD-MM-YYYY" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="asal_sekolah" id="asal_sekolah" placeholder="Masukan Asal Sekolah" class="form-control">
