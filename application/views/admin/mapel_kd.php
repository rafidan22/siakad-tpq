<div class="container-fluid">
        ...
        <div class="card-body">
            <form action="" method="post">
                <div class="form-group">
                    ...
                    <!-- <input type="text" name="komp_dasar" id="komp_dasar" placeholder="Masukan Materi" class="form-control"> -->
                    <div class="input-group control-group after-add-kd">
                        <input type="text" name="kd[]" class="form-control" id="komp_dasar" placeholder="Masukan KD">
            ...
            <table class="table table-responsive table-striped table-bordered table-hover w-100 d-block d-md-table table-sm">
                ...
                <tbody>
                    ...
                    <?php foreach ($komp_dasar as $key => $value) : ?>
                        <?php if ($name_kd !== $value->nama_materi) : ?>
                            <tr>
                                <td><?= ++$no ?></td>
                                <td><?= $value->nama_materi ?></td>
                                <td class="text-center"><a href="<?= base_url(); ?>admin/mapel/delete_kd?id_mapel=<?= $mapel['id_mapel'] ?>&kd=<?= $value->nama_materi ?>" class="btn btn-sm btn-danger btn-xs mr-1 ml-1 mb-1 btn-delete-kd"><i class="fa fa-trash"></i></a></td>
                            </tr>
                        <?php endif; ?>
                        <?php $name_kd = $value->nama_materi; ?>
                    <?php endforeach ?>
                </tbody>
            </table>
        </div>
    ...
    <div class="kd-copy invisible">
        <div class="input-group control-group mt-2">
            <input type="text" name="kd[]" class="form-control" id="komp_dasar_add" placeholder="Masukan KD">
            <div class="input-group-btn">
