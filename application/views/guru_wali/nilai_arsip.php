            ...
            $(document).ready(function() {
                $('#newjenis').change(function() {
                    ...
                    $(document).on('click', '#setcancelarchive', function() {
                        const href = '<?= base_url('walikelas/nilai/archive_cancel') ?>' + `?id_jilid=${idjilid}&id_mapel=${idMapel}&id_materi=${idKd}&nilai=${jetgl_masukilai}&oldjenis=${oldJenisTugas}&newjenis=${newJenisTugas}`;
